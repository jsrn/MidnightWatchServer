...
namespace Server.Engines.Craft
{
	public class DefTinkering : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			AddRes( index, typeof( HealPotion ), "Healing potion", 1, "The kit needs some potions." );
			AddRes( index, typeof( CurePotion ), "Cure potion", 1, "The kit needs some potions." );
			#endregion
			...
			index = AddCraft( typeof( Candle ), 1044050, "candle", 30.0, 70.0, typeof( IronIngot ), 1044036, 1, 1044037 );
			AddRes( index, typeof( Beeswax ), "beeswax", 2, 1044253 );
			#endregion
			...
			index = AddCraft( typeof( GasMineDeed ), 1044052, "gas mine", 75.0, 100.0, typeof( IronIngot ), 1044036, 40, 1044037 );
			AddRes( index, typeof( BasePoisonPotion ), 1044571, 1, 1044253 );
			AddRes( index, typeof( Gears ), 1044254, 1, 1044253 );
			AddRes( index, typeof( Springs ), 1044171, 1, 1044253 );
			AddSkill( index, SkillName.Poisoning, 50.0, 50.0 );

			index = AddCraft( typeof( LandMineDeed ), 1044052, "land mine", 75.0, 100.0, typeof( IronIngot ), 1044036, 40, 1044037 );
			AddRes( index, typeof( Gears ), 1044254, 1, 1044253 );
			AddRes( index, typeof( Springs ), 1044171, 1, 1044253 );
			AddRes( index, typeof( BaseExplosionPotion ), 1044569, 1, 1044253 );

			index = AddCraft( typeof( SawMineDeed ), 1044052, "saw trap", 60.0, 85.0, typeof( IronIngot ), 1044036, 40, 1044037 );
			AddRes( index, typeof( Gears ), 1044254, 1, 1044253 );

			// Faction Spike Trap			
			index = AddCraft( typeof( SpikeMineDeed ), 1044052, "spike trap", 60.0, 85.0, typeof( IronIngot ), 1044036, 40, 1044037 );
			AddRes( index, typeof( Springs ), 1044171, 1, 1044253 );

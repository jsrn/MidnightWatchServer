...
namespace Server.Engines.Craft
{
	public class DefInscription : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			AddCraft( typeof( BrownBook ), 1044294, "brown book", 0.00, 50.0, typeof( BlankScroll ), 1044377, 5, 1044378 );
			AddCraft( typeof( TanBook ), 1044294, "tan book", 0.00, 50.0, typeof( BlankScroll ), 1044377, 5, 1044378 );
